...
<c:url var="addStoneInVitroTest" value="/addStoneInVitroTest"/>
...
<div class="container">
    <fieldset>
        ...
        <form:form cssClass="form-horizontal" method="post" action="${addStoneInVitroTest}" modelAttribute="stoneInVitroTest">
            <div class="row">
